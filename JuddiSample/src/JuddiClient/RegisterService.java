...
public class RegisterService {
	...
	public void registerService(String authToken,
		...
		String businessEntityKey = createBusinessEntity(authToken, config);
		...
		myServName.setValue(config.getBusinessServiceName());
		businessService.getName().add(myServName);
		Description desc = new Description();
		desc.setValue("The Payment Business Service");
		businessService.getDescription().add(desc);

		String serviceKey = createBusinessService(authToken, businessService);
		System.out.println("created Business Service:  " + serviceKey);

		String bindingKey = createBinding(authToken, config, businessService,
				serviceKey);
	...
	private String createBinding(String authToken,
		...
		for (TModel tm : tModelList) {
			...
			instanceDetails.setInstanceParms("g24 tModel instance");
		...
		AccessPoint helloworldAccessPoint = createAccessPoint(config.getUrl());
		myTemplate.setAccessPoint(helloworldAccessPoint);
